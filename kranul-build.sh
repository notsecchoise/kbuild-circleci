...
if [ -z "6410284454:AAESx0jgdzy-z4W0t-Oo53NaaS-mhGka8_4" ] || [ -z "-1002088104319" ]
then
...
DEVICE_MODEL="Mi Sdm439"

# Specify name of device codename.
# e.g: 'begonia'
DEVICE_CODENAME="mi439"
...
DEVICE_DEFCONFIG=lineageos_mi439_defconfig
